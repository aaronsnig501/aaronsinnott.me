...
export const ga: Record<keyof typeof en, string> = {
	'languageChooser.logo': 'aaronsinnott.me',
	'languageChooser.promptGa': 'Conas ba mhaith leat an suíomh a léamh?',
	'languageChooser.promptEn': 'How would you like to read the site?',
	'languageChooser.gaeilge': 'Gaeilge',
	'languageChooser.asGaeilge': 'As Gaeilge',
	'languageChooser.english': 'English',
	...
	'hero.titleEnd': 'do theangacha ba chóir a mhaireachtáil freisin.',
	'hero.subheading':
		'Oibrím ar chórais dháilte ardghéire de lá agus tógaim bonneagar don athbheochan teanga san oíche. Doimhneacht theicniúil, innealtóireacht ionraic, agus creideamh fírinneach gur slí mhaireachtála cultúir é misneach laethúil.',
	'hero.languageTag': 'Gaeilge · Portugáilis · Béarla',
